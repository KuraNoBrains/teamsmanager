...
angular.module("templates/tags.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/tags.html",
    ...
    "       <span popover-placement=\"bottom\" popover-title=\"{{typeaheadOptions.popoverTitle}}\" \n" +
    "             popover=\"{{typeaheadOptions.popoverText}}\" popover-trigger=\"mouseenter\" \n" +
    "             class=\"decipher-tags-tag\" data-ng-class=\"getClasses(tag)\">{{tag.name}}\n" +
    "           <i class=\"fa fa-times\" data-ng-click=\"remove(tag)\"></i>\n" + //icon-remove
    "       </span>\n" +
    "    </span>\n" +
    "  </div>\n" +
    " \n" +
